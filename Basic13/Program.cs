...
namespace Basic13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] numArray3 = {1,-2,3,4,-6};
            // PrintNumbers();
            // PrintOdds();
            // PrintSum();
            // LoopArray(numArray2);
            // Console.WriteLine(FindMax(numArray2));
            // GetAverage(numArray2);
            // int[] oddArr = OddArray();
            // for(int i=0; i<oddArr.Length; i++){
            //     Console.WriteLine(oddArr[i]);
            // }
            // Console.WriteLine(GreaterThanY(numArray2, 2));
            // SquareArrayValues(numArray2);
            // EliminateNegatives(numArray3);
            // MinMaxAverage(numArray3);
            // ShiftValues(numArray2);
            NumToString(numArray3);
        }
